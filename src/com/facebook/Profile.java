...
public final class Profile implements Parcelable {
        ...
        Utility.getGraphMeRequestWithCacheAsync(accessToken.getToken(),
                new Utility.GraphMeRequestWithCacheCallback() {
                    ...
                    public void onSuccess(JSONObject userInfo) {
                    	Log.e("", "getGraphMeRequestWithCacheAsync --> "+userInfo.toString());
    ...
    public boolean equals(Object other) {
        ...
        return id.equals(o.id) &&
                ...
                email == null ? o.email == null : email.equals(o.email) &&
    ...
    Profile(JSONObject jsonObject) {
        ...
        email = jsonObject.optString(EMAIL_KEY, null);
